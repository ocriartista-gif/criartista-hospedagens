...
export async function getPublicSiteData(
  ...
  return {
    property: {
      ...
      mapsUrl: propertyRow.maps_url ?? "",
      timezone: propertyRow.timezone ?? "America/Sao_Paulo",
      checkInTime: propertyRow.check_in_time ?? "15:00",
      checkOutTime: propertyRow.check_out_time ?? "12:00",
      childrenPolicy: propertyRow.children_policy ?? "",
      petsPolicy: propertyRow.pets_policy ?? "",
      cancellationPolicy: propertyRow.cancellation_policy ?? "",
